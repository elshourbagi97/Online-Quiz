...
<body>
    <section>
       ...
       <ul class="nav nav2 nav-tabs">
            <li class="nav-item">
                <a class="nav-link res" style="margin-right:5px;" href="quiz.php" title="Questions">Questions</a>
            </li>
            <li class="nav-item">
                        ...
                        if($result=$conn->query($select)){
                            while($row=$result->fetch_assoc()){
                                ...
                                <tr>
                                    ...
                                    <td><a href="delResult.php?id=<?php echo $resID?>"class="btn btn-outline-danger" title="Delete"><i class="fa-solid fa-trash"></i></a></td>
                                </tr>
                    <?php
                            }
                        }
